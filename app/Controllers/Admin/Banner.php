...
class Banner extends BaseController
{
    ...
    public function create(){
        ...
        if(!$file->isValid()) return redirect()->back()->with("error", "Banner Image tidak valid");
        ...
        if(!$q) return redirect()->back()->with("error", "gagal menyimpan data Banner");

        return redirect()->back()->with("success", "berhasil menyimpan data Banner");
    }
    ...
    public function update(){
        ...
        if(!empty($file->getName())) {
            if(!$file->isValid()) return redirect()->back()->with("error", "banner tidak valid");
